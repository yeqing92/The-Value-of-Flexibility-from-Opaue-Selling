...
def run_lost_K(K, l,L, iteration, sRange,SRange):
    N = 5
    h = 6
    ...
    for S in SRange:
        print(S)
        for s in sRange:
             result[s,S] =lostCost2OPQ(s, S, N, K, h,L, 0.1, lamb ,l, iteration)
    print("!!!0.1 done!!!")
    ...
    for S in SRange:
        print(S)
        for s in sRange:
             result2[s,S] =lostCost2OPQ(s, S, N, K, h,L, 0.2, lamb ,l, iteration)
    print("!!!0.2 done!!!")
